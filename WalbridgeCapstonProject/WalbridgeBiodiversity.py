...
print('Number of different species : ',species_count)
...
plt.savefig('ConservationStautsBySpecies.png')
plt.show()
...
chi2_contingency(reptile_mammal)
...
plt.savefig('ObservationSheep.png')
plt.show()
...
#just over two at Bryce and just over one at Yellowstone
